      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-16">
        ...
        <div className="mx-auto grid max-w-4xl grid-cols-1 gap-6 md:grid-cols-2 lg:gap-8">
          {members.map((m) => (
            <article
              key={m.name}
              className="group relative flex h-full flex-col overflow-hidden rounded-[1.5rem] border border-champagne/20 bg-onyx shadow-luxe transition-all duration-500 hover:border-champagne/50 hover:shadow-glow"
            >
              {/* Portrait */}
